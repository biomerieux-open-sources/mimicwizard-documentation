...
For Windows user, you need to install Rtools to compile some of the packages, available on the `Rtools official repository <https://cran.r-project.org/bin/windows/Rtools/>`_ (don't forget to add R and Rtools to your PATH environment variable, for Rtools please add : ``rtools44\x86_64-w64-mingw32.static.posix\bin`` and ``rtools44\usr\bin``).
